...
var ASM_CONSTS = {
  1024: function() {FS.mkdir('/offline'); FS.mount(IDBFS, {}, '/offline'); FS.writeFile('/offline/any_file.txt', ""); FS.syncfs(true, function (err) { });},  
 1194: function() {FS.syncfs(function (err) { });}
};
